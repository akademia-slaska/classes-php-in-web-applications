...
<body>
  ...
  <div class="container">
    ...
    <form class="d-flex" action="" method="GET">
      <input class="form-control me-2" value="<?php echo $search_query; ?>" type="search" name="search_query" placeholder="Search people..." aria-label="Search">
  ...
  <div class="container">
     <div class="row">
        <?php if (!empty($users)): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <div class="col-12"><div class="alert alert-warning text-center" role="alert">No contacts found.</div></div>
        <?php endif; ?>
    </div>
